...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Histogram-based Gradient Boosting Classifier Trainer")
    ...
    parser.add_argument("--random_state", type=int, default=333, help="Random state for reproducibility.")
    ...
    parser.add_argument("--output_metrics", type=str, required=True, help="Path to save the output metrics CSV file.")
